<link rel="stylesheet" href="/assets/css/registrant-navbar.css">  
  ...
  <nav class="navbar sticky-top navbar-expand-md custom-navbar py-3" style="background: var(--bs-white);">
      <div class="container"><a class="navbar-brand d-flex align-items-center" href="/home"><span
                  class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"
                  style="background: var(--bs-dark);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                  ...
                  </svg></span><span style="color: var(--bs-dark);"><strong>LC Happy Care</strong></span></a><button
          ...
          <div class="collapse navbar-collapse" id="navcol-1">
              <ul class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item"><a class="nav-link" href="/#faqssection">FAQs</a></li>
              </ul><a class="btn btn-light me-2" role="button" href="/login-user">Login</a><a class="btn btn-primary"
